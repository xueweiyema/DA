...
public class CalendarPickerView extends ListView {
    ...
    public void setDauser(DAuser dauser) {
        this.dauser = dauser;
    }
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        titleTextColor = a.getColor(R.styleable.CalendarPickerView_titleTextColor, res.getColor(R.color.calendar_text_active));
        displayHeader = a.getBoolean(R.styleable.CalendarPickerView_displayHeader, true);
        headerTextColor = a.getColor(R.styleable.CalendarPickerView_headerTextColor, res.getColor(R.color.calendar_text_active));
        a.recycle();
    ...
    private class CellClickedListener implements MonthView.Listener {
        ...
        public void handleClick(MonthCellDescriptor cell) {
            ...
            //Toast.makeText(getContext(), clickedDate.toString(), Toast.LENGTH_SHORT).show();
            //显示每天上班的执勤队
            Toast t = Toast.makeText(getContext(), dauser.getDutyTeam(clickedDate), Toast.LENGTH_SHORT);
            ToastMaster.setToast(t);
            t.show();
    ...
    private void validateDate(Date date) {
        ...
        if (date.before(minCal.getTime()) || date.after(maxCal.getTime())) {
            throw new IllegalArgumentException(String.format("SelectedDate must be between minDate and maxDate." + "%nminDate: %s%nmaxDate: %s%nselectedDate: %s",
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (monthView == null) {
                monthView = MonthView.create(parent, inflater, weekdayNameFormat, listener, today, dividerColor, dayBackgroundResId, dayTextColorResId, titleTextColor,
                        displayHeader, headerTextColor);
            }
            //传入DAuser
            monthView.setDauser(dauser);
    ...
    /**
     * Interface to be notified when a cell is clicked and possibly intercept
     * the click. Return true to intercept the click and prevent any selections
     * from changing.
     *
